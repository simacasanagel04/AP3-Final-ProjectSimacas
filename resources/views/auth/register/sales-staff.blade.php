    ...
    <div class="max-w-4xl mx-auto">
            ...
            <div class="inline-flex items-center justify-center w-20 h-20 bg-primary-dark rounded-full mb-4 shadow-xl">
                <svg class="w-10 h-10 text-accent-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                          d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0A5.002 5.002 0 019 5c0-1.105-.895-2-2-2m0 0a5.002 5.002 0 0110 0m-10 0a5.002 5.002 0 0110 0m-10 0h10"/>
                </svg>
            </div>
            <h1 class="text-3xl font-bold text-primary-dark mb-2">Sales Staff Registration</h1>
            <p class="text-secondary-blue font-medium">Join our team and help students find their perfect lessons</p>
        </div>
        ...
        <div class="card animate-fade-in">
            <div class="p-6 md:p-10">
                ...
                <form method="POST" action="{{ route('register.sales.process') }}" class="space-y-8">
                    @csrf
                    ...
                    <div class="flex flex-col md:flex-row gap-4 pt-6">
                        <button type="submit" class="btn-primary flex-1">Create Sales Staff Account</button>
